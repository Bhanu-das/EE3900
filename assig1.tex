...
\author{ Bhanu Prakash$^{*}$ %<-this  stops a space
...
https://github.com/Bhanu-das/EE3900/blob/main/Assign1/codes/8.1.py
	...
	\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{8_1.png}
\caption{}
\label{fig:8_1}
\end{figure}
	...
	\begin{lstlisting}
https://github.com/Bhanu-das/EE3900/blob/main/Assign1/codes/8_2_1.py
	\end{lstlisting}
	\begin{figure}[!ht]
\centering
...
\end{figure}
	...
	\begin{lstlisting}
		https://github.com/Bhanu-das/EE3900/blob/main/Assign1/codes/8_2_2.py
	\end{lstlisting}
	\begin{figure}[!ht]
\centering
...
\end{figure}
	...
	\begin{lstlisting}
https://github.com/Bhanu-das/EE3900/blob/main/Assign1/codes/8_2_3.py
	\end{lstlisting}
	\begin{figure}[!ht]
\centering
