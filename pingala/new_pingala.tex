...
\author{VEERAVALLI BHANU PRAKASH\\MS20BTECH11026}
...
\begin{lstlisting}
weget https://github.com/Bhanu-das/EE3900/blob/main/pingala/pingala1.py
\end{lstlisting}
...
\begin{lstlisting}
weget https://github.com/Bhanu-das/EE3900/blob/main/pingala/pingala_2_1.py
\end{lstlisting}
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{pfig1.png}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
...
Download the Python code using
\begin{lstlisting}
wget https://github.com/Bhanu-das/EE3900/blob/main/pingala/pingala2.py
\end{lstlisting}
\begin{figure}[!htbp]
    \includegraphics[width=\columnwidth]{pfig2.png}
    \caption{Plot of $y(n)$}
    \label{fig:yn}
\end{figure}
\item Find $Y^{+}(z)$. 
